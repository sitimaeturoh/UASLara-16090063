...
<body>
    ...
    <ul class="navbar-nav mr-auto">
        ...
        <a class="nav-link" href="/pariwisata">Home <span class="sr-only">(current)</span></a>
        </li>
        <li class="nav-item active">
        <a class="nav-link" href="/pariwisata/wisata">Wisata <span class="sr-only">(current)</span></a>
        </li>
        <li class="nav-item active">
        <a class="nav-link" href="/pariwisata">About <span class="sr-only">(current)</span></a>
        </li>
        @if(Auth::check() && \Auth::user()->hasRole('admin'))
        <li class="nav-item">
        <a class="nav-link" href="/pariwisata/admin">Panel</a>
        </li>
        @endif
        @if (Auth::check() && \Auth::user()->hasRole('member'))
        <li class="nav-item">
        <a class="nav-link" href="/pariwisata/users">Kontak</a>
        </li>
        @endif
